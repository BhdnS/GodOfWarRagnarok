export default class Lang {
  constructor() {
    ...
    this.buyNow = document.querySelectorAll('.buyNow');
    this.buyDual = document.querySelector('#buyDual');
    this.headerSubtitle = document.querySelector('#headerSubtitle');
    this.editionsLang = document.querySelectorAll('.editionsLang');
    this.aboutGameLang = document.querySelectorAll('.aboutGameLang');
    ...
    this.realease = document.querySelector('#realease');
    this.d = document.querySelector('#d');
    this.h = document.querySelector('#h');
    this.m = document.querySelector('#m');
    this.standardEdition = document.querySelectorAll('.standardEdition');
    this.offline = document.querySelectorAll('.offline');
    this.remote = document.querySelectorAll('.remote');
    this.trigger = document.querySelectorAll('.trigger');
    this.changePrice = document.querySelector('#changePrice');
    this.digital = document.querySelector('#digital');
    this.allFeatures = document.querySelector('#allFeatures');
    this.armour = document.querySelector('#armour');
    this.soundtrack = document.querySelector('#soundtrack');
    this.dualTextOne = document.querySelector('#dualTextOne');
    this.dualTextTwo = document.querySelector('#dualTextTwo');
    this.dualTitle = document.querySelector('.dual__title');
    this.controller = document.querySelectorAll('.controllerLang');
    this.explore = document.querySelectorAll('.exploreLang');
    this.exploreTitle = document.querySelector('.explore_title');
    this.exploreSubtitle = document.querySelector('#exploreSubtitlePC');
    this.minimum = document.querySelector('#minimum');
    this.recommended = document.querySelector('#recommended');
    this.exploreSubtitlePS = document.querySelector('#exploreSubtitlePS');
    this.standard = document.querySelector('#standard');
    this.limited = document.querySelector('#limited');
    this.newsLang = document.querySelectorAll('.newsLang');
    this.newsCardOneTitle = document.querySelector('#newsCardOneTitle');
    this.newsCaraOneText = document.querySelector('#newsCaraOneText');
    this.newsCardTwoTitle = document.querySelector('#newsCardTwoTitle');
    this.newsCardTwoText = document.querySelector('#newsCardTwoText');
    this.newsCardTitleThree = document.querySelector('#newsCardTitleThree');
    this.newsCardThreeText = document.querySelector('#newsCardThreeText');
    this.footerLang = document.querySelector('.footer_lang');
    this.footerPara = document.querySelector('.footer_para');
    this.faqSubtitleOne = document.querySelector('#faqSubtitleOne');
    this.faqTxtOne = document.querySelector('#faqTxtOne');
    this.faqSubtitleTwo = document.querySelector('#faqSubtitleTwo');
    this.faqTxtTwo = document.querySelector('#faqTxtTwo');
    this.popupSumma = document.querySelector('.popup_summa');
    this.popupPara = document.querySelector('.popup_para');
    this.popupAgree = document.querySelector('.popup_agree');
    this.popupInstant = document.querySelector('.popup_instant');
    this.popupExpire = document.querySelector('.popup_expire');
    this.popupCard = document.querySelector('.popup_card');
    this.popupSubtitle = document.querySelector('.popup_subtitle');
    this.faqLang = document.querySelectorAll('.faqLang');
  }
